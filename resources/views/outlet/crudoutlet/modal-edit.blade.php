<div data-twe-modal-init
    ...
    id="outlet-edit{{ $FADHIL_outlet->id }}" data-twe-backdrop="static" data-twe-keyboard="false" tabindex="-1"
    aria-labelledby="outlet-editLabel" aria-hidden="true">
    <div data-twe-modal-dialog-ref
        ...
        <div
            ...
            {{-- <p>Debug Outlet ID: {{ $FADHIL_outlet->id }}</p> --}}
            <!-- Modal body -->
            <div class="p-4" data-twe-modal-body-ref>
                <form action="{{ route('outlet.update', $FADHIL_outlet->id) }}" method="POST"
                    id="outletFormEdit{{ $FADHIL_outlet->id }}">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        <label for="nama" class="text-neutral-500 dark:text-neutral-400">Nama Outlet:</label>
                        <input type="text" name="nama"
                            ...
                            id="nama" value="{{ old('nama', $FADHIL_outlet->nama) }}" />
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat"
                            ...
                            id="alamat">{{ old('alamat', $FADHIL_outlet->alamat) }}</textarea>
                        @error('alamat')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" name="tlp"
                            ...
                            id="tlp" value="{{ old('tlp', $FADHIL_outlet->tlp) }}" />
                        @error('tlp')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div
                ...
                <button type="submit" form="outletFormEdit{{ $FADHIL_outlet->id }}"

...
<div data-twe-modal-init
    ...
    id="outlet-create" data-twe-backdrop="static" data-twe-keyboard="false" tabindex="-1"
    aria-labelledby="outlet-createLabel" aria-hidden="true">
    <div data-twe-modal-dialog-ref
        ...
        <div
            ...
            <div
                ...
                <!-- Modal title -->
                <h5 class="text-xl font-medium leading-normal text-surface dark:text-white" id="outlet-createLabel">
                    Tambah Outlet
                </h5>
                <!-- Close button -->
                <button type="button"
            ...
            <div class="p-4" data-twe-modal-body-ref>
                <form action="{{ route('outlet.store') }}" method="POST" id="outletForm">
                    @csrf
                    <div class="mb-3">

...
<div data-twe-modal-init
    ...
    id="outlet-hapus{{ $FADHIL_outlet->id }}" data-twe-backdrop="static" data-twe-keyboard="false" tabindex="-1"
    aria-labelledby="outlet-hapusLabel" aria-hidden="true">
        ...
        <div
            ...
            <div class="p-4 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-neutral-500 dark:text-neutral-400">
                    ...
                    Outlet : <strong>{{ $FADHIL_outlet->nama }}</strong></h3>
                </h3>
                <form action="{{ route('outlet.destroy', $FADHIL_outlet->id) }}" method="POST"
                    id="outletFormHapus{{ $FADHIL_outlet->id }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
            ...
            <div
                ...
                <button type="submit" form="outletFormHapus{{ $FADHIL_outlet->id }}"

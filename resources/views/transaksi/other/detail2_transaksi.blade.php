    ...
    <div class="py-2 bg-white shadow-[0_1px_3px_rgba(0,0,0,0.15)]">
        <div class="container px-4 mx-auto">
            <div class="flex items-center justify-between">
                <h1 class="text-lg font-bold text-gray-800 uppercase">Invoice Laundry</h1>
                <!-- Breadcrumbs -->
                <nav class="text-sm text-gray-600">
                    <ol class="flex space-x-2">
                        <li>
                            <a href="{{ route('transaksi') }}" class="hover:text-gray-800">Transaksi</a>
                        </li>
                        <li>
                            <span>/</span>
                        </li>
                        <li class="font-medium text-gray-900">Invoice</li>
                    </ol>
                </nav>
            </div>
        </div>

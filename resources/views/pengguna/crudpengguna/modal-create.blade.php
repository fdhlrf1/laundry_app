...
<div data-twe-modal-init
    ...
    id="pengguna-create" data-twe-backdrop="static" data-twe-keyboard="false" tabindex="-1"
    aria-labelledby="pengguna-createLabel" aria-hidden="true">
    <div data-twe-modal-dialog-ref
        ...
        <div
            ...
            <div
                ...
                <!-- Modal title -->
                <h5 class="text-xl font-medium leading-normal text-surface dark:text-white" id="pengguna-createLabel">
                    Tambah Pengguna
                </h5>
                <!-- Close button -->
                <button type="button"
                    ...
                    @if (Auth()->user()->role == 'super_admin')
                        <div class="mb-3">
                            ...
                            <select name="role" id="role"
                                ...
                                {{-- <option value="owner" {{ $FADHIL_pengguna->role === 'owner' && $FADHIL_pengguna->id_outlet === Auth()->user()->id_outlet ? 'disabled' : '' }}>
                                    Owner
                                </option> --}}
                                <option value="owner">
                                    Owner
                    ...
                    @elseif (Auth()->user()->role == 'admin')
                        <div class="mb-3">
                            ...
                            <select name="role" id="role"
                                ...
                                {{-- <option value="owner"
                                    {{ $FADHIL_pengguna->role == 'owner' && $FADHIL_pengguna->id_outlet == Auth()->user()->id_outlet ? 'disabled' : '' }}>
                                    Owner
                                </option> --}}
                                <option value="owner">
                                    Owner
            ...
            <div
                ...
                <button type="submit" form="penggunaForm"

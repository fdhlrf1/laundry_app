        ...
        <div class="py-2">
            <div class="px-6 mx-auto max-w-7xl sm:px-6 md:px-6">
                        ...
                        <div class="flex items-center w-full max-w-2xl space-x-2">
                            ...
                            <div class="relative flex-grow">
                                ...
                                <input id="search" name="search"
                                    ...
                                    placeholder="Cari member" type="search">
                            </div>
                            <!-- Search Button -->
                            <button type="submit"
                ...
                <button type="button"
                    ...
                    data-twe-toggle="modal" data-twe-target="#member-create" data-twe-ripple-init
                    data-twe-ripple-color="light">
                    Tambah Member baru
                </button>
            </div>

            @include('member.createmember.modal-create')

            <div class="bg-white rounded-lg shadow">
                <div class="p-6 border-b border-gray-200">
                    <h2 class="text-lg font-medium text-gray-900">Data Member</h2>
                </div>
                <div class="overflow-x-auto">
                    <table class="min-w-full table-auto">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse ($FADHIL_members as $FADHIL_member)
                                @include('member.createmember.modal-edit')
                                @include('member.createmember.modal-delete')
                                <tr>
                                    <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">
                                        {{ $loop->iteration + $FADHIL_members->firstItem() - 1 }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">
                                        {{ $FADHIL_member->nama }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">
                                        {{ $FADHIL_member->alamat }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900 capitalize whitespace-nowrap">
                                        @if ($FADHIL_member->jenis_kelamin == 'L')
                                            Laki-Laki
                                        @elseif ($FADHIL_member->jenis_kelamin == 'P')
                                            Perempuan
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-900 capitalize whitespace-nowrap">
                                        {{ $FADHIL_member->tlp }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">
                                        <button type="button"
                                            ...
                                            data-twe-target="#member-edit{{ $FADHIL_member->id }}" data-twe-ripple-init
                                            data-twe-ripple-color="light">
                                            Edit
                                        </button>
                                        <button type="button"
                                            ...
                                            data-twe-toggle="modal"
                                            data-twe-target="#member-hapus{{ $FADHIL_member->id }}" data-twe-ripple-init
                                            data-twe-ripple-color="light">
                                            Hapus
                                        </button>
                                    </td>

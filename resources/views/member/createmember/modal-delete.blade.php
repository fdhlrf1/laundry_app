...
<div data-twe-modal-init
    ...
    id="member-hapus{{ $FADHIL_member->id }}" data-twe-backdrop="static" data-twe-keyboard="false" tabindex="-1"
    aria-labelledby="member-hapusLabel" aria-hidden="true">
        ...
        <div
            ...
            <div class="p-4 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-neutral-500 dark:text-neutral-400">
                    ...
                    Nama Member : <strong class="capitalize">{{ $FADHIL_member->nama }}</strong>
                </h3>
                </h3>
                <form action="{{ route('member.destroy', $FADHIL_member->id) }}" method="POST"
                    id="memberFormHapus{{ $FADHIL_member->id }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
            ...
            <div
                ...
                <button type="submit" form="memberFormHapus{{ $FADHIL_member->id }}"

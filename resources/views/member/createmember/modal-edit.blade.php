<div data-twe-modal-init
    ...
    id="member-edit{{ $FADHIL_member->id }}" data-twe-backdrop="static" data-twe-keyboard="false" tabindex="-1"
    aria-labelledby="member-editLabel" aria-hidden="true">
    <div data-twe-modal-dialog-ref
        ...
        <div
            ...
            <div class="p-4" data-twe-modal-body-ref>
                <form action="{{ route('member.update', $FADHIL_member->id) }}" method="POST"
                    id="memberFormEdit{{ $FADHIL_member->id }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama"
                            ...
                            id="nama" value="{{ old('nama', $FADHIL_member->nama) }}" />
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat"
                            ...
                            id="alamat">{{ old('alamat', $FADHIL_member->alamat) }}</textarea>
                        @error('alamat')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="jenis_kelamin" id="jenis_kelamin"
                            ...
                            <option value="" disabled
                                {{ old('jenis_kelamin', $FADHIL_member->jenis_kelamin) == '' || in_array($FADHIL_member, ['L', 'P']) ? 'selected' : '' }}>
                                -- Pilih Jenis Kelamin --</option>
                            <option value="L"
                                {{ old('jenis_kelamin', $FADHIL_member->jenis_kelamin) == 'L' ? 'selected' : '' }}>
                                Laki-Laki
                            </option>
                            <option value="P"
                                {{ old('jenis_kelamin', $FADHIL_member->jenis_kelamin) == 'P' ? 'selected' : '' }}>
                                Perempuan
                            </option>
                        </select>
                        @error('jenis_kelamin')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="tlp"
                            ...
                            id="tlp" value="{{ old('tlp', $FADHIL_member->tlp) }}" />
                        @error('tlp')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div
                ...
                <button type="submit" form="memberFormEdit{{ $FADHIL_member->id }}"

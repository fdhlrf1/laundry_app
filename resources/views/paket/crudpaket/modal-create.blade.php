...
<div data-twe-modal-init
    ...
    id="paket-create" data-twe-backdrop="static" data-twe-keyboard="false" tabindex="-1" aria-labelledby="paket-createLabel"
    aria-hidden="true">
    <div data-twe-modal-dialog-ref
        ...
        <div
            ...
            <div
                ...
                <!-- Modal title -->
                <h5 class="text-xl font-medium leading-normal text-surface dark:text-white" id="paket-createLabel">
                    Tambah Paket Cucian
                </h5>
                <!-- Close button -->
                <button type="button"
                ...
                <form action="{{ route('paket.store') }}" method="POST" id="paketForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_paket"
                            ...
                            id="nama_paket" value="{{ old('nama_paket') }}" />
                        @error('nama_paket')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="lama_proses"
                            ...
                            id="lama_proses" value="{{ old('lama_proses') }}" />
                        @error('lama_proses')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div
                ...
                <button type="submit" form="paketForm"

...
<div data-twe-modal-init
    ...
    id="paket-hapus{{ $FADHIL_paket->id }}" data-twe-backdrop="static" data-twe-keyboard="false" tabindex="-1"
    aria-labelledby="paket-hapusLabel" aria-hidden="true">
        ...
        <div
            ...
            <div class="p-4 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-neutral-500 dark:text-neutral-400">
                    ...
                    Nama Outlet : <strong>{{ $FADHIL_paket->outlet->nama }}</strong> <br>
                    Paket Cucian : <strong>{{ $FADHIL_paket->nama_paket }}</strong>
                </h3>
                <form action="{{ route('paket.destroy', $FADHIL_paket->id) }}" method="POST"
                    id="paketFormHapus{{ $FADHIL_paket->id }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
            ...
            <div
                ...
                <button type="submit" form="paketFormHapus{{ $FADHIL_paket->id }}"
